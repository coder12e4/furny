                   ...
                   Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          txtOfFurnone(data: "Height", textstyle:Constants().semiboldstyleTxt(16),),
                          txtOfFurnone(data: "100 Cm", textstyle:Constants().regularstyleTxt(16),),
                        ],
                      ),
                      SizedBox(
                        height: 12,
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          txtOfFurnone(data: "Width", textstyle:Constants().semiboldstyleTxt(16),),
                          txtOfFurnone(data: "42 Cm", textstyle:Constants().regularstyleTxt(16),),
                        ],
                      ),
                      SizedBox(
                        height: 12,
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          txtOfFurnone(data: "Weight", textstyle:Constants().semiboldstyleTxt(16),),
                          txtOfFurnone(data: "12 Kg", textstyle:Constants().regularstyleTxt(16),),
                        ],
                      ),
                      SizedBox(
                        height: 12,
